...
const apk='https://github.com/mudrikazq24/bukucatering_landing/releases/download/v1.0.0/BukuCatering-v1.0.0.apk';
const features=[
...
<section className="download"><img src="/bukucatering-icon.svg"/><div><span>BUKUCATERING v1.0.0</span><h2>Siap bikin pengelolaan pesanan lebih rapi?</h2><p>Download BukuCatering untuk perangkat Android kamu.</p></div><a className="btn light" href={apk} ><Download size={20}/> Download APK</a></section>
